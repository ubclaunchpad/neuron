...
import { ClassDetailsAside } from "@/components/classes/class-details-aside";
import { ClassesEmptyView } from "@/components/classes/classes-empty-view";
import {
  CategoriesNav,
  ClassesGrid
...
export function ClassesView() {
  ...
  const openSidebarFor = useCallback(
    (id: string) => {
  ...
  const isInitializing = isLoadingTerms || 
    (hasTerms && !selectedTermId && isLoadingCurrentTerm);
  
  const isLoadingContent = isInitializing || 
    (!!selectedTermId && isLoadingClassList);
