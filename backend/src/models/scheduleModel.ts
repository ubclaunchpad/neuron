...
export default class ScheduleModel {
    ...
    setSchedulesByClassId(classId: string, scheduleItems: Schedule[]): Promise<any> {
        return new Promise((resolve, reject) => {
            const query = `INSERT INTO schedule (fk_class_id, day_of_week, start_time, end_time) VALUES ?`;
    ...
    deleteSchedulesByScheduleId(classId: string, scheduleIds: string[]): Promise<any> {
        return new Promise((resolve, reject) => {
