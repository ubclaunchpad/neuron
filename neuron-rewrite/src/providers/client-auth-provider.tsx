...
export default function ClientAuthProvider({
  ...
  const [bootstrapped, setBootstrapped] = useState((initialSession || initialSession === null) as boolean);
  ...
  const session = isPending && bootstrapped ? stableRef.current : liveSession ?? stableRef.current;
