...
ALTER TABLE "coverage_request" ADD CONSTRAINT "coverage_requesting_volunteer_user_id_volunteer_user_id_fk" FOREIGN KEY ("requesting_volunteer_user_id") REFERENCES "public"."volunteer"("user_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "coverage_request" ADD CONSTRAINT "coverage_covered_by_volunteer_user_id_volunteer_user_id_fk" FOREIGN KEY ("covered_by_volunteer_user_id") REFERENCES "public"."volunteer"("user_id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
