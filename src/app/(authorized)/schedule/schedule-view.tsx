...
export function ScheduleView() {
  ...
  const [currentView, setCurrentView] = useState<CalendarView | "listView">("listView");
    ...
    return <div className="navbar">
        ...
        <div>
          <Select 
            ...
            onValueChange={(value: CalendarView | "listView") => setCurrentView(value)}
            >
            <SelectTrigger><SelectValue /></SelectTrigger>
            <SelectContent>
              <SelectItem value="listView">List View</SelectItem>
