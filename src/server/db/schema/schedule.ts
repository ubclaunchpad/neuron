...
export const schedule = pgTable(
  "schedule",
  {
    ...
    preferredVolunteerCount: smallint("preferred_volunteer_count").notNull(),
  },
  (table) => [
...
export const volunteerToSchedule = pgTable(
  "volunteer_to_schedule",
  {
  ...
  (table) => [
    primaryKey({
      name: "pk_volunteer_schedule",
      columns: [table.volunteerUserId, table.scheduleId],
    }),
...
export const volunteerToScheduleRelations = relations(
  volunteerToSchedule,
  ({ one }) => ({
...
export const instructorToSchedule = pgTable(
  "instructor_to_schedule",
  {
    instructorUserId: uuid("instructor_user_id")
      .notNull()
  ...
  (table) => [
    primaryKey({
      name: "pk_instructor_schedule",
      columns: [table.instructorUserId, table.scheduleId],
    }),
...
export const instructorToScheduleRelations = relations(
